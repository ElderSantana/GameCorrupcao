...
class AlternativeNewsAdapter(var context: Activity, val alternatives: List<Alternatives>, val idquestion: String) : RecyclerView.Adapter<AlternativeNewsAdapter.ViewHolder>() {
